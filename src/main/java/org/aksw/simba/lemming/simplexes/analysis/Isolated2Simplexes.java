 ...
 */
public class Isolated2Simplexes extends AbstractFindSimplexes{
	 ...
	 */
	private ObjectObjectOpenHashMap<TriangleColours, double[]> mIsolatedTriColoEdgesTriCountDistAvg;

	public Isolated2Simplexes(ColouredGraph[] origGrphs, int desiredNoVertices, int iNoOfVersions, FindTriangles computedTriObjects) {
