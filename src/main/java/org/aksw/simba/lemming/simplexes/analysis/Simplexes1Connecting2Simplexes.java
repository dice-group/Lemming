 ...
 */
public class Simplexes1Connecting2Simplexes extends AbstractFindSimplexes {
	...
	public Simplexes1Connecting2Simplexes(ColouredGraph[] origGrphs, int desiredNoVertices, int iNoOfVersions, FindTriangles computedTriObjects){
