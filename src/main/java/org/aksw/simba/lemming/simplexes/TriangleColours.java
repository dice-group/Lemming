...
public class TriangleColours {
	private BitSet a, b, c;	

    public TriangleColours(BitSet a, BitSet b, BitSet c) {
        set(a, b, c); // sorting logic for the bitset
    }

    TriangleColours(TriangleColours t) {
        this.a = t.a;
        this.b = t.b;
        this.c = t.c;
    }    
    ...
    */
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TriangleColours other = (TriangleColours) obj;
    ...
    public Object clone() throws CloneNotSupportedException {
        return new TriangleColours(this);
    }
