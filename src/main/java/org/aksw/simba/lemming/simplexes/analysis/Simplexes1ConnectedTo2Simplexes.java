 ...
 */
public class Simplexes1ConnectedTo2Simplexes extends AbstractFindSimplexes {
	...
	public Simplexes1ConnectedTo2Simplexes(ColouredGraph[] origGrphs, int desiredNoVertices, int iNoOfVersions, FindTriangles computedTriObjects) {
