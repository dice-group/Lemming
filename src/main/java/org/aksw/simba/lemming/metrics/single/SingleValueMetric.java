...
public interface SingleValueMetric extends Metric {
     ...
     * @param newMetricResult - UpdatableMetricResult object containing the results that could be updated.
     * @return - metric result.
     */
    public default UpdatableMetricResult applyUpdatable(ColouredGraph graph, boolean graphOperation, TripleBaseSingleID triple, UpdatableMetricResult newMetricResult) {
