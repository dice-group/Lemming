 ...
 * given graph. This is done using the so called node-iterator algorithm
...
public class NodeIteratorMetric extends AbstractMetric implements TriangleMetric {
    ...
    /**
     * Count triangles on in a given graph, and the triangles which are formed by
     * the given node set vertices are not taken into account.
     * 
     * @param graph    an instance of {@link IColouredGraph}.
     * @param vertices a set of nodes, and it is a subset of nodes from the given
     *                 graph.
     * @return Amount of triangles
     */
    public int calculateTriangles(IColouredGraph graph, IntSet vertices) {
