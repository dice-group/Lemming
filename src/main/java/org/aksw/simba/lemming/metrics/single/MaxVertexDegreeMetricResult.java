...
/** The class stores the candidate's set and their metric values, which is used for computing the max vertex degrees for different metrics.
 * @author Atul
 *
 */
public class MaxVertexDegreeMetricResult extends SimpleMetricResult 
{
	...
	private HashMap<GRAPHOPERATION, IntSet> mMapCandidatesMetricTemp; // Temp Map for storing candidate vertices for metric computation
	...
	private HashMap<GRAPHOPERATION, IntSet> mMapCandidatesMetric= new HashMap<>(); // Map for storing candidate vertices for Max Degree metric computation
	private HashMap<GRAPHOPERATION, Double> mMapCandidatesMetricValues= new HashMap<>(); // Map for storing max degree of vertices
	 ...
	 * @param mMapCandidatesMetricTemp1 - Input map containing the candidates that needs to be updated.
	 * @param key - GRAPHOPERATION ENUM denoting the key that needs to be updated.
	 */
	public void setmMapCandidatesMetricTemp(HashMap<GRAPHOPERATION, IntSet> mMapCandidatesMetricTemp1,GRAPHOPERATION key) {
	 ...
	 * @param mMapCandidatesMetricValuesTemp1 -  - Input map containing the metric values that needs to be updated.
	 * @param key - GRAPHOPERATION ENUM denoting the key that needs to be updated.
	 */
	public void setmMapCandidatesMetricValuesTemp(HashMap<GRAPHOPERATION, Double> mMapCandidatesMetricValuesTemp1, GRAPHOPERATION key) {
	 ...
	 */
	public void setCandidatesMetricRemoveAnEdge(HashMap<GRAPHOPERATION, IntSet> mMapCandidatesMetric1, HashMap<GRAPHOPERATION, Double> mMapCandidatesMetricValues1) {

		mMapCandidatesMetric.replace(GRAPHOPERATION.RemoveAnEdgeIndegree, mMapCandidatesMetric1.get(GRAPHOPERATION.RemoveAnEdgeIndegree));
		mMapCandidatesMetric.replace(GRAPHOPERATION.RemoveAnEdgeOutdegree, mMapCandidatesMetric1.get(GRAPHOPERATION.RemoveAnEdgeOutdegree));
		mMapCandidatesMetricValues.replace(GRAPHOPERATION.RemoveAnEdgeIndegree, mMapCandidatesMetricValues1.get(GRAPHOPERATION.RemoveAnEdgeIndegree));
		mMapCandidatesMetricValues.replace(GRAPHOPERATION.RemoveAnEdgeOutdegree, mMapCandidatesMetricValues1.get(GRAPHOPERATION.RemoveAnEdgeOutdegree));
	 ...
	 * @param mMapCandidatesMetricValues1 - Map storing the candidate values.
	 */
	public void setCandidatesMetricAddAnEdge(HashMap<GRAPHOPERATION, IntSet> mMapCandidatesMetric1, HashMap<GRAPHOPERATION, Double> mMapCandidatesMetricValues1) {

		mMapCandidatesMetric.replace(GRAPHOPERATION.AddAnEdgeIndegree, mMapCandidatesMetric1.get(GRAPHOPERATION.AddAnEdgeIndegree));
		mMapCandidatesMetric.replace(GRAPHOPERATION.AddAnEdgeOutdegree, mMapCandidatesMetric1.get(GRAPHOPERATION.AddAnEdgeOutdegree));
		mMapCandidatesMetricValues.replace(GRAPHOPERATION.AddAnEdgeIndegree, mMapCandidatesMetricValues1.get(GRAPHOPERATION.AddAnEdgeIndegree));
		mMapCandidatesMetricValues.replace(GRAPHOPERATION.AddAnEdgeOutdegree, mMapCandidatesMetricValues1.get(GRAPHOPERATION.AddAnEdgeOutdegree));
	...
	public void verifyCandidates(GRAPHOPERATION metricName,TripleBaseSingleID triple ) {
		for(GRAPHOPERATION key:mMapCandidatesMetric.keySet()) {
			if(!(key == metricName)) {
