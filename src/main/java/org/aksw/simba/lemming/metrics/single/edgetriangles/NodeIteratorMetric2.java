...
public class NodeIteratorMetric2 {
	 ...
	 */
	ObjectObjectOpenHashMap<TriangleColours, double[]> mTriColoEdgesTriCountDistAvg = new ObjectObjectOpenHashMap<TriangleColours, double[]>();
	 ...
	 */
	ObjectObjectOpenHashMap<TriangleColours, double[]> mIsolatedTriColoEdgesTriCountDistAvg = new ObjectObjectOpenHashMap<TriangleColours, double[]>();
    ...
    public void computeTriangles(ColouredGraph graph){
    	...
    	ObjectObjectOpenHashMap<TriangleColours, double[]> mTriangleColoursTriangleEdgeCountsTemp = new ObjectObjectOpenHashMap<TriangleColours, double[]>();
    	
    	//************************** Variables Declaration for Isolated Triangles ********************************************//
    	//temporary map to store count of edges and triangles, which is later used to compute probabilities
    	ObjectObjectOpenHashMap<TriangleColours, double[]> mIsolatedTriColosTriEdgeCountsTemp = new ObjectObjectOpenHashMap<TriangleColours, double[]>();
