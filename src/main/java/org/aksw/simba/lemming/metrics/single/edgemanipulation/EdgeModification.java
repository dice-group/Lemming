...
public class EdgeModification {
    ...
    private ColouredGraph copyOfGraph;
    ...
    void removeEdgeFromGraph(int edgeId) {
        ...
        Grph grph = copyOfGraph.getGraph();
        ...
        this.copyOfGraph.removeEdge(edgeId);
    ...
    public void removeEdgeFromGraph(int edgeId, int newNodeTriangles, int newEdgeTriangles, boolean useCopy) {
        ...
        ColouredGraph graph = (useCopy) ? this.copyOfGraph : this.graph;
        // For removing an edge from a graph, update the vertex in and out degrees.
    ...
    public int addEdgeToGraph(int tail, int head, BitSet color, int newNodeTriangles, int newEdgeTriangles,
        ...
        mVertexDegrees.updateVertexOutdegree(tail, 1);
        if (useCopy) {
            return copyOfGraph.addEdge(tail, head, color);
        } else {
