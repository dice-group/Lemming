...
public class Inferer {
	 ...
	 * 
	 * @param sourceModel
	 *            RDF Model where we want the inference to take place
	 * @param ontModel
	 *            Ontology Model
	 ...
	 * 
	 * @param model
	 *            RDF Model from where the resources are extracted
	 ...
	 * 
	 * @param set
	 *            group of resources that we want to check in the model if a type
	 *            relation is existing or not
	 * @param model
	 *            RDF Model where this needs to be checked in
	 */
	 ...
	 * 
	 * @param newModel
	 *            model where we will add the new triples
	 * @param sourceModel
	 *            provided model where we iterate through the statements
	 * @param ontModel
	 *            the ontology model
	 */
	 ...
	 * 
	 * @param statement
	 *            statement in which we want to check the predicate in the ontology
	 * @param ontModel
	 *            the ontology model
	 * @param newModel
	 *            where we add the new triples and therefore, where we check if the
