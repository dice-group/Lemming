package org.aksw.simba.lemming.util.querypattern;
...
/**
 * 
 * This QueryHandler uses query patterns and converts them into query
 * instances.<br/>
 * A query pattern is a SPARQL 1.1 Query which can have additional variables
 * %%var[0/9]+%% in the Basic Graph Pattern. <br/>
 * <br/>
 ...
 * and will request query solutions from a user given sparql endpoint (e.g
 * DBpedia)<br/>
 * The solution will then be instantiated into the query pattern. The result can
 * look like follows:<br/>
 * <br/>
 * SELECT * {?s &lt;http://prop/1&gt; ?o . ?o &lt;http://exa.com&gt; "123"}<br/>
 * SELECT * {?s &lt;http://prop/1&gt; ?o . ?o &lt;http://exa.com&gt; "12"}<br/>
 * SELECT * {?s &lt;http://prop/2&gt; ?o . ?o &lt;http://exa.com&gt;
 * "1234"}<br/>
 * 
 * 
 * @author f.conrads
...
//	private static final Logger LOGGER = LoggerFactory.getLogger(PatternQueryHandler.class);
//
//	private String service;
//
//	private Long limit = 2000l;
//
//	public PatternQueryHandler(String endpoint) {
//		this.service = endpoint;
//	}
//
//	public PatternQueryHandler(String endpoint, long limit) {
//		this.service = endpoint;
//		this.limit = limit;
//	}
//
//	public PatternQueryHandler(String endpoint, String limit) {
//		this(endpoint, Long.parseLong(limit));
//	}
//
...
//	}
//
//	protected Query[] generateQueryPerLine(String queryFileName, String idPrefix, int hashcode) {
...
//			// query is instance
//			LOGGER.debug("[QueryHandler: {{}}] Query is already an instance: {{}}", this.getClass().getName(),
//					queryStr);
...
//		if (!exchange.hasNext()) {
//			// no solution
//			LOGGER.warn("[QueryHandler: {{}}] Query has no solution, will use variables instead of var instances: {{}}",
//					this.getClass().getName(), queryStr);
