...
public class GraphGenerationSimplexApproach2 extends AbstractGraphGeneration implements IGraphGeneration {
	 ...
	 */
	private ObjectObjectOpenHashMap<TriangleColours, double[]> mTriangleColoursTriangleEdgeCounts;
	
	private Set<TriangleColours> setAllTriangleColours;
	 ...
	 */
	private ObjectObjectOpenHashMap<TriangleColours, List<IntSet>> mTriangleColorsVertexIds; 
	 ...
	 */
	private ObjectObjectOpenHashMap<TriangleColours, List<IntSet>> mIsolatedTriangleColorsVertexIds = new ObjectObjectOpenHashMap<TriangleColours, List<IntSet>>();
	...
	*/
	...
	public GraphGenerationSimplexApproach2(int iNumberOfVertices,
		...
		//TODO: Analyze object initialization and method calls that can be moved to super class AbstractGraphGeneration
		//TODO: Analyze objects that are not used outside the constructor and move their declaration inside the constructor. For example, Edge Ids used to create colour mappers are mostly likely to be not used outside the constructor.
	...
	public ColouredGraph generateGraph(){
		...
		if (initialRandomTriangle!=null) { // TODO: Add condition for estimatedEdgesTriangle should be >= 3 and estimatedVerticesTriangle >= 3
			...
			while (actualEdgesInTriangles< estimatedEdgesTriangle) { // Case: Triangles cannot be added to the mimic graph but edges can be added to existing triangles
					...
					TriangleColours proposeTriangleToAddEdge = triangledistributionObject.proposeTriangleToAddEdge(setTriangleColorsMimicGraph);
		...
		OfferedItemByRandomProb<TriangleColours> potentialIsolatedTriangleProposer = triangledistributionObject.getPotentialIsolatedTriangleProposer(); // get isolated triangle proposer
		...
		while ((estimatedEdgesIsolatedTriangle > actualEdgesSimplexes) && (iterationCount < 5000)) {
			...
			if (setIsoTriInMimicGraph.size() > 0) {
				...
				// Logic for adding edges to existing triangles
				TriangleColours proposeTriangleToAddEdge = triangledistributionObject.proposeTriangleToAddEdge(setIsoTriInMimicGraph);
