...
public class ColouredGraph {
   ...
   protected ObjectArrayList<BitSet> vertexColours = new ObjectArrayList<>();
   protected ObjectArrayList<BitSet> edgeColours = new ObjectArrayList<>();
   ...
   public void setVertexColour(int vertexId, BitSet colour) {
      if (vertexId < vertexColours.elementsCount) {
         vertexColours.buffer[vertexId] = colour;
      }
   }
   ...
   public void setEdgeColour(int edgeId, BitSet colour) {
      if (edgeId < edgeColours.elementsCount) {
         edgeColours.buffer[edgeId] = colour;
      }
   }
   ...
   public BitSet getVertexColour(int vertexId) {
      if (vertexId < vertexColours.elementsCount) {
         return (BitSet) vertexColours.buffer[vertexId];
      } else {
         return new BitSet();
      }
   }
   ...
   public BitSet getEdgeColour(int edgeId) {
      if (edgeId < vertexColours.elementsCount) {
         return (BitSet) vertexColours.buffer[edgeId];
      } else {
         return new BitSet();
      }
   }
