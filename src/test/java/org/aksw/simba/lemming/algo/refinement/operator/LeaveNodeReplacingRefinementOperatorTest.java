...
public class LeaveNodeReplacingRefinementOperatorTest {
    ...
    public static List<Object[]> data() {
        ...
        tests.add(new Object[] { VARIABLES[0],
                new Expression[] { new Operation(VARIABLES[0], VARIABLES[0], Operator.PLUS),
        ...
        tests.add(new Object[] { new Operation(VARIABLES[0], VARIABLES[1], Operator.PLUS),
                new Expression[] { new Operation(new Operation(VARIABLES[0], VARIABLES[0], Operator.PLUS), VARIABLES[1],
                        Operator.PLUS),
        ...
        tests.add(
                new Object[] { new Operation(new Operation(VARIABLES[0], VARIABLES[1], Operator.PLUS), VARIABLES[2],
                        Operator.PLUS), new Expression[] {
                                new Operation(
                                        new Operation(new Operation(VARIABLES[0], VARIABLES[0], Operator.PLUS),
                        ...
                        new Operation(
                                ...
                                new Operation(new Operation(VARIABLES[0],
                                        new Operation(VARIABLES[1], VARIABLES[1], Operator.PLUS), Operator.PLUS),
                                VARIABLES[2], Operator.PLUS), new Operation(
                                        new Operation(VARIABLES[0],
                                        ...
                                        VARIABLES[2], Operator.PLUS),
                                new Operation(new Operation(VARIABLES[0],
                                        new Operation(VARIABLES[1], VARIABLES[0], Operator.TIMES), Operator.PLUS),
                                VARIABLES[2], Operator.PLUS), new Operation(
                                        new Operation(VARIABLES[0],
