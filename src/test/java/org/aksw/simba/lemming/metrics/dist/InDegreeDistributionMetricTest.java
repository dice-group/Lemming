...
public class InDegreeDistributionMetricTest {

    private static final int EXPECTED_DEGREES[] = new int[] { 0, 1, 2 };
    private static final double EXPECTED_DEGREE_VALUES[] = new double[] { 1, 3, 1 };
