...
public class AvgVertexDegreeMetricTest extends UpdateMetricTest {
    ...
    public void testcase1() {
        ...
        RemoveEdgeDecorator remDecorator = new RemoveEdgeDecorator(buildGraph1);
        ...
        remDecorator = new RemoveEdgeDecorator(buildGraph1);
        remDecorator.setTriple(triple);
        buildGraph1 = removeEdge(buildGraph1, triple.edgeId);
        ...
        // add an edge 4 = (1, 2);
        AddEdgeDecorator addDecorator = new AddEdgeDecorator(buildGraph1);
        ...
        // add an edge 4 = (2, 2);
        addDecorator = new AddEdgeDecorator(buildGraph1);
    ...
    public void testcase2() {
        ...
        RemoveEdgeDecorator remDecorator = new RemoveEdgeDecorator(buildGraph2);
        remDecorator.setTriple(triple);
        ...
        // add an edge 0 = (0, 1);
        AddEdgeDecorator addDecorator = new AddEdgeDecorator(buildGraph2);
        ...
        // add an edge 4 = (1, 1);
        addDecorator = new AddEdgeDecorator(buildGraph2);
