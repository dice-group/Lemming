...
public class SemanticWebDogFoodDatasetTest extends SemanticWebDogFoodDataset {
    ...
    private int numOfGraphsToRead;
    
    public SemanticWebDogFoodDatasetTest(int numOfGraphsToRead){
    	this.numOfGraphsToRead = numOfGraphsToRead;
    }
    ...
    public ColouredGraph[] readGraphsFromFiles(String dataFolderPath) {
        ...
        int trackNumAnalyzedInputGraphs = 0;
        ...
        for (int y = START_YEAR; y <= END_YEAR; ++y) {
            ...
            if (folder.exists()) {
                ...
                if (oldModelSize < dogFoodModel.size()) {
                    ...
                    // increment number of input graphs analyzed
                    trackNumAnalyzedInputGraphs++;
                    
                    // break if input number of graphs are read
                    if (trackNumAnalyzedInputGraphs == numOfGraphsToRead)
                    	break;
                } else {
