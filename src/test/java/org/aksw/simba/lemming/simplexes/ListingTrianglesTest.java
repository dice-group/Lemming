...
public class ListingTrianglesTest {
...
//		
		...
		System.out.println("Edges and triangles counts information (Class Nodes):");
		ObjectIntOpenHashMap<TriangleColours> mTrianglesColoursEdgeCountsClassNodes = metric.getmTrianglesColoursEdgeCountsClassNodes();
		System.out.println(mTrianglesColoursEdgeCountsClassNodes);
		ObjectIntOpenHashMap<TriangleColours> mTrianglesColoursTrianglesCountsClassNodes = metric.getmTrianglesColoursTrianglesCountsClassNodes();
		System.out.println(mTrianglesColoursTrianglesCountsClassNodes);
...
//		}
		...
		System.out.println(metric.getmGraphsEdgesIdsNotInTriangle());
...
//		System.out.println(isFirstSmallerthanSecond(vertexColours.get(1), vertexColours.get(1)));
	...
	public void testComputeStats() {
		...
		System.out.println(metric.getmTrianglesColoursTrianglesCountsClassNodes());
