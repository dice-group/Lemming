...
public class SimpleGraphFormatReaderTest {
   ...
   public void testReadingCorrectFile() throws IOException {
      ColouredGraph graph = SimpleGraphFormatReader.readSimpleGraphFormatFileFromResources("creation/correct_simple_format_file.txt");
   ...
   public void testReadingFileWithNumberFormatError() throws IOException {
      SimpleGraphFormatReader.readSimpleGraphFormatFileFromResources("creation/number_format_error_simple_format_file.txt");
   }


   @Test(expected = RuntimeException.class)
   public void testReadingFileWithGeneralFormatError() throws IOException {
      SimpleGraphFormatReader.readSimpleGraphFormatFileFromResources("creation/general_format_error_simple_format_file.txt");
   }
}
